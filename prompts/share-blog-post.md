...
필수 원칙:
- 기존 프로젝트명, 레거시 자동화명, 과거 전화번호는 절대 쓰지 않습니다.
- 대표번호는 1688-0976만 사용합니다.
- 법률 자문처럼 단정하지 말고, 자료 기준 1차 검토와 상담 접수 안내로 작성합니다.
- 주소나 사건번호만 있어도 검토를 시작할 수 있다는 메시지를 자연스럽게 포함합니다.
- 등기부, 지분율, 공유자 수, 점유 상태, 경매 진행 여부, 권리관계, 보류 사유, 추가자료 필요 여부를 주제에 맞춰 다룹니다.
- 공개 글에서는 입찰가, 입찰 일정, 공유물분할 방법, 소송 절차, 가격 산정, 협상 전략, 권리 행사 방법을 설명하지 않습니다.
