...
- 기존 저장소 상태: 정기 발행 엔진은 프록시 호출, JSON 파싱 보정, QA 실패 시 1회 재생성, 템플릿 fallback, sitemap/feed/blog hub 갱신, 저수량 백로그 자동 보충을 지원한다.
...
9. 발행 후 `/blog/`, `/feed.xml`, `sitemap.xml`, 메인 최신 블로그 링크를 갱신하고 커밋·푸시한다.
